...
namespace Lykke.Service.ClientAssetRule.Client.AutorestClient.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RuleModel class.
        /// </summary>
        public RuleModel()
        {
            CustomInit();
        ...
        /// Initializes a new instance of the RuleModel class.
        /// </summary>
        public RuleModel(string id = default(string), string name = default(string), string regulationId = default(string), IList<string> allowedAssetGroups = default(IList<string>), IList<string> declinedAssetGroups = default(IList<string>))
        {
            Id = id;
            Name = name;
